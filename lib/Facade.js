...
var Facade = function (_Component) {
  ...
  function Facade() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Facade.__proto__ || Object.getPrototypeOf(Facade)).call.apply(_ref, [this].concat(args))), _this), _this.deselect = function () {
      _this.app.deselect();
    }, _this.onAddFolder = function (parentId) {
      var _extends2;
