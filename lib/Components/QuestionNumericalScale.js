...
var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; // Scale with marks
...
var Meta = function Meta(_ref2) {
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      FormItem,
      _extends({ min: 0, max: 100, label: 'max' }, formItemLayout),
      _react2.default.createElement(_EditFields.NumericInput, { value: value.max, onChange: function onChange(max) {
          return _onChange({ max: max });
        } })
    ),
    _react2.default.createElement(
      FormItem,
      _extends({ min: 0, max: 100, label: 'pas' }, formItemLayout),
      _react2.default.createElement(_EditFields.NumericInput, { value: value.step, onChange: function onChange(step) {
