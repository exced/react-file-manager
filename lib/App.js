...
var App = function (_Component) {
  ...
  function App(props) {
    ...
    _this.onDragEnd = function (result) {
      ...
      _this.setState({ map: map, autoFocusId: autoFocusId });
  ...
  _createClass(App, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          onOutsideDrop = _props.onOutsideDrop,
          dropzoneConfig = _props.dropzoneConfig;
...
App.propTypes = {
  ...
  onChangeColumn: _propTypes2.default.func.isRequired,
  onOutsideDrop: _propTypes2.default.func.isRequired,
  dropzoneConfig: _propTypes2.default.object.isRequired,
